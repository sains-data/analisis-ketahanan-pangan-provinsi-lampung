...
docker exec spark-master /spark/bin/spark-submit --master spark://spark-master:7077 /src/etl/gold/calc_indikator.py

echo "[Gold] Running Spark job: calc_gold_enriched.py..."
docker exec spark-master /spark/bin/spark-submit --master spark://spark-master:7077 /src/etl/gold/calc_gold_enriched.py
